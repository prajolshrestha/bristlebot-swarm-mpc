...
DRAW_INTERVAL  = 10
SAVE_GIF       = False
GIF_NAME       = f"reynolds_swarm_{BEHAVIOR_MODE.value}_tcoupled_sync_hard_obs.gif"
SAVE_VIDEO     = False
VIDEO_NAME     = f"reynolds_swarm_{BEHAVIOR_MODE.value}_tcoupled_sync_hard_obs.mp4"
