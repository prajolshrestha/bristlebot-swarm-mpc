...
def run_obstacle_avoidance_animation():
    ...
    ctrl_a.update_slack_weights(w_soft=1e7, w_soft_obs=1e7, w_soft_lin=1000.0, w_soft_obs_lin=1000.0)
    ctrl_b.update_slack_weights(w_soft=1e7, w_soft_obs=1e7, w_soft_lin=1000.0, w_soft_obs_lin=1000.0)
