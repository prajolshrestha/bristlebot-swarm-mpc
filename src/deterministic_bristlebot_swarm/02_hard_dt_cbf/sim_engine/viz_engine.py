...
from expert_src.controller import MAX_NEIGHBOURS
...
DRAW_INTERVAL  = 10
SAVE_GIF       = False
GIF_NAME       = f"reynolds_swarm_{BEHAVIOR_MODE.value}_tcoupled_sync_hard_dt_cbf.gif"
SAVE_VIDEO     = False
VIDEO_NAME     = f"reynolds_swarm_{BEHAVIOR_MODE.value}_tcoupled_sync_hard_dt_cbf.mp4"
...
class PhototaxisSim(HeadlessSim):
    ...
    def __init__(self,
                 ...
                 q_om=Q_OM,   r_u=R_U,
                 q_coh=Q_COHESION, q_ali=Q_ALIGN,
        ...
        self.q_coh, self.q_ali = float(q_coh), q_ali
    ...
    def _print_summary(self):
        ...
        print(f"  D_safe:           {D_SAFE*100:.0f} cm  |  D_safe_obs: {D_SAFE_OBS*100:.0f} cm  |  Weights: qc={self.q_coh:g}, qa={self.q_ali:g}")
