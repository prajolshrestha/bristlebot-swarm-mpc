...
RESULTS_BASE_DIR = "ablation_results_hard_dt_cbf"
...
class HeadlessSim:
    def __init__(self, n_robots=10, behavior_mode=SwarmBehavior.PHOTOTAXIS,
                 q_coh=GLOBAL_Q_COH, q_ali=GLOBAL_Q_ALI, max_consensus=MAX_CONSENSUS,
                 q_pos=60.0, q_theta=80.0, q_vel=1.5, q_om=1.5, r_u=0.01,
