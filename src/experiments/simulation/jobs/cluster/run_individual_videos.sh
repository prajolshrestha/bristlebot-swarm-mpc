...
#
# Twelve single-behavior submission videos at the Elsevier recommended frame size.
#
#   cd src/experiments/simulation
#   sbatch jobs/cluster/run_individual_videos.sh
#
# This is a TRANSCODE, not a simulation: it windows the existing 900 s clips in
# results/videos/ down to their first 180 s and re-encodes at 492x276 / 750 kbps.
...
python behaviors_src/make_individual_videos.py "$@"
rc=$?
